...
**Frontend Developer** · Bangladesh<br />
I build fast, responsive web interfaces with React and Next.js, pixel-perfect and brought to life with smooth animations.
